...
import { BuscarInstituicoesAction, BuscarInstituicoesVinculadasAction } from "../actions/instituicao.actions";
...
export class InstituicaoVinculadaStateModel {
  instituicoesVinculadas: ResponseData<ResponsePaginacao<Instituicao>> | null;
}
...
@State<InstituicaoVinculadaStateModel>({
    name: "instituicoesVinculadas",
    defaults: {
      instituicoesVinculadas: null,
    }
  })
...
export class InstituicaoState {
  ...
  @Action(BuscarInstituicoesAction)
  buscarInstituicoesVinculada({ getState, setState }: StateContext<InstituicaoVinculadaStateModel>,
    { payload }: BuscarInstituicoesVinculadasAction): Observable<ResponseData<ResponsePaginacao<Instituicao>>> {
    return this.buscarInstituicoesUseCase.execute(payload).pipe(
      tap({
        next: (response: ResponseData<ResponsePaginacao<Instituicao>>) => {
          const state = getState();
          setState({
            ...state,
            instituicoesVinculadas: response,
          });
        }, error: () => {
          setState({
            instituicoesVinculadas: null
