...
import { AlertaPorCdStateModel, AlertaState, AlertaStateModel, VeiculoState, VeiculoStateModel } from "../states/alerta.state";
...
export class AlertaSelectors {
  ...
  @Selector([AlertaState])
  static alertaPorCd(state: AlertaPorCdStateModel) {
    return state.alerta?.data
  }
