...
export class BuscarListaAlertaUseCase {
  ...
  public execute(filter?: ListaAlertaFilter): Observable<ResponseData<ResponsePaginacao<ListaAlertaResponse>>> {
    return this.listaAlertaRepository.buscarListaAlertas(filter)
  }
}
